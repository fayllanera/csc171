...
3. You will be then directed to the 8-Tile Puzzle page.
...
4. Intructions:
  ...
  Additionally, below the Solve and Refresh buttons, the user will be able to see the Run Time and the Number of Explored Nodes for both BFS and A*. 